...
public class PinyinEngine {
    ...
    static {
        ...
        add("lian", list("连", "脸", "练", "联"), list("連", "臉", "練", "聯"));
        add("yuan", list("元", "原", "员", "园", "远", "院"), list("元", "原", "員", "園", "遠", "院"));
        add("tian", list("天", "田", "填", "甜"), list("天", "田", "填", "甜"));
        add("mian", list("面", "棉", "免", "绵"), list("面", "棉", "免", "綿"));
        add("bian", list("边", "变", "便", "编"), list("邊", "變", "便", "編"));
        ...
        add("miantiao", list("面条"), list("麵條"));
        add("yuanlai", list("原来"), list("原來"));
        add("yuanyin", list("原因"), list("原因"));
        add("yuanyi", list("愿意"), list("願意"));
        add("lianxi", list("联系"), list("聯繫"));
        add("lianhe", list("联合"), list("聯合"));
        add("lianjie", list("连接"), list("連接"));
        add("biancheng", list("变成"), list("變成"));
        add("bianhua", list("变化"), list("變化"));
        add("bianli", list("便利"), list("便利"));
        add("tianqi", list("天气"), list("天氣"));
        add("tiantian", list("天天"), list("天天"));
